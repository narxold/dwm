...
static const char col_border[] = "#7f7f7f";
...
//	{ MODKEY,			XK_s,      togglescratch,  {.v = scratchpadcmd } },
	...
	{ MODKEY|ShiftMask,		XK_Down,   spawn,   SHCMD("pamixer -d 5") }, 
	{ MODKEY|ShiftMask,		XK_Up,   spawn,   SHCMD("pamixer -i 5") }, 
	...
	{ MODKEY|ShiftMask,		XK_e,		spawn,	   SHCMD("bash ~/.scripts/dmenu/powermenu") },
